...
checks.update({
    ...
    'split photo slots follow the frame, product frames are not deep-cropped': 'def _photo_aspect' in pipeline and 'min_slot, max_slot' in pipeline and 'ideal > height * 1.15' in pipeline and "for index in (2, 3):" in pipeline,
