...
checks = {
    ...
    'base style version bumped': 'BASE_STYLE_VERSION = "12.5"' in prompts,
    'feature uses a real gallery photo': 'def select_feature_photo' in pipeline and 'select_feature_photo(ranked_references, selected_reference)' in tasks and "'feature_prompt': ''" in main and 'feature-photo.png' in tasks,
