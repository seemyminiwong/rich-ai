...
checks = {
    ...
    'base style version bumped': 'BASE_STYLE_VERSION = "12.64"' in prompts and prompts.count('BASE_STYLE_VERSION = ') == 1,
...
checks.update({
    ...
    'split photo cards get the contract slot height': 'slot_height = 420 if variant' in pipeline and "for index in (2, 3):" in pipeline,
