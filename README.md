...
<!-- ГАЛЕРЕЯ: коли зʼявиться скрін, розкоментуйте його рядок. Файли кладуться в docs/images/.
![Головна: проєкти та їх статуси](docs/images/projects.png)
![Готова rich-сторінка товару](docs/images/workspace-preview.png)
![Рушій стилів](docs/images/styles.png)
![Готовий промо-лендінг](docs/images/landing-page.png)
-->

![Створення промо-лендінгу: товари, категорії, стиль і режим фону hero](docs/images/landing-create-dialog.png)
